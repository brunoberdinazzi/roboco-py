...
def iniciar_copia():
    ...
    if direcao_copia == "windows_para_windows":
        copia_arquivos.copiar_windows_para_windows(origem, destino, copiar_vazios, copiar_ocultos)
    elif direcao_copia == "linux_para_linux":
        copia_arquivos.copiar_linux_para_linux(origem, destino, copiar_vazios, copiar_ocultos)
    elif direcao_copia == "windows_para_linux":
        copia_arquivos.copiar_windows_para_linux(origem, destino, copiar_vazios, copiar_ocultos)
    elif direcao_copia == "linux_para_windows":
        copia_arquivos.copiar_linux_para_windows(origem, destino, copiar_vazios, copiar_ocultos)
...
# Adiciona entradas para definir a quantidade de memória e núcleos
memoria_label = tk.Label(janela, text="Memória (MB):")
entrada_memoria = tk.Entry(janela)
cores_label = tk.Label(janela, text="Cores da CPU:")
...
# Organiza as entradas de memória e núcleos da CPU
